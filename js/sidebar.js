var showSidebar = {
	'show':function(){
		...
		html += '<br /><br />';
		html += '<br /><br />';
		html += '<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Add Comment </button>';
	...
	'get_posts':function() {
	    ...
	    html += '<span class="post-title" target="_blank">Mohamed Fathi</span>';
	    html += '</h3>';
